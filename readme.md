...
<mark>[NENA Data Stuctures Committee](https://www.nena.org/page/DataStructures)</mark>
...
**Subject to change when Issues handling is resolved in ADM-012.**
...
The best way to contribute is to join the Example working group and to submit comments while documents are under revision or review. More information at (XYZ).
